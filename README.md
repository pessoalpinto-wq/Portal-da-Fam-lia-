...
| 💰 **Finanças** | Dois separadores. **👛 Dinheiro das filhas**: "na carteira" (pode gastar) e "nos mealheiros" (guardado) lado a lado, **mesada paga automaticamente** com a data da próxima, botões "Gastei" e "Poupar", resumo do mês e movimentos. **🏠 Contas da casa** (só os pais vêem): atrasadas, próximos 30 dias, pagas este mês e custo fixo médio por mês. **Poupança divertida**: porquinho que enche (festa aos 25/50/75/100 %), previsão de quando se chega ao objectivo, **🏦 Banco dos Pais** (juros mensais nos mealheiros, com máximo), arredondar o troco dos gastos para o mealheiro, semanas seguidas a poupar e 8 medalhas. |
...
js/poupanca.js             juros do Banco dos Pais, previsões e medalhas de poupança
